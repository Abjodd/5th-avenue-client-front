...
export function EmptyState({ icon = "◎", title, hint, actionLabel, onAction }) {
  return (
    <div className="rounded-[20px] border border-dashed border-line-mid bg-glass-soft px-6 py-11 text-center backdrop-blur-sm transition-colors duration-300 hover:border-accent/25 hover:bg-glass">
