      ...
      {!leaving && (
        ...
        >
          ...
          <button
            ...
            className="absolute right-6 top-6 z-10 flex size-10 cursor-pointer items-center justify-center rounded-full border border-line bg-glass text-[15px] text-sub shadow-sm backdrop-blur-md transition-all duration-200 hover:scale-105 hover:text-ink hover:shadow-md"
          >
            ✕
          </button>
