...
function Hero() {
  ...
  return (
    <div className="relative">
      ...
      <div ref={wrapRef} className="relative z-10 mx-auto flex min-h-[78vh] max-w-[1600px] flex-col justify-center px-5 pb-10 pt-24 sm:px-9">
        <div
          ref={flashRef}
          aria-hidden
        ...
        <div data-hero-fade className="mb-5 flex flex-wrap items-center gap-4">
          <LiveDot label="Fifth Avenue Intelligence" />
          <span className="h-3 w-px bg-black/15 dark:bg-white/15" />
          <span className="font-mono text-[10px] font-semibold uppercase tracking-[0.24em] text-black/45 dark:text-white/35">
        ...
        <h1
          ...
          className="max-w-4xl cursor-pointer select-none text-[clamp(40px,7.4vw,92px)] italic leading-[0.98] tracking-[-0.02em] text-[#171410] dark:text-white"
        ...
        <p data-hero-fade className="mt-6 max-w-xl text-[14.5px] leading-relaxed text-black/60 dark:text-white/55">
        ...
        <div data-hero-fade className="mt-9 flex flex-wrap items-center gap-x-5 gap-y-3">
          {SECTIONS.map((s, i) => (
            <span key={s.id} className="flex items-center gap-x-5">
              ...
              <a
                ...
                className="group relative inline-flex items-baseline gap-2 font-serif text-[16px] italic text-black/55 transition-colors duration-200 hover:text-[#171410] dark:text-white/50 dark:hover:text-white sm:text-[17.5px]"
              >
                <span className="font-mono text-[10.5px] font-semibold not-italic tracking-[0.14em] text-black/35 dark:text-white/30">{s.roman}</span>
                {s.label}
        ...
        <div data-hero-fade className="mt-14 flex justify-start">
